    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/asli.png" alt="" width="20%"> </a>
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        ...
                                        <input type="submit" class="btn theme-btn" style="margin-left:40px; font-size: 13px; padding: 6px 12px;" value="Add To Cart" />
                                    </div>
                                    </form>
                                </div>
